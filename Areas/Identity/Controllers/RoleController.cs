...
using blog.Areas.Identity.Models.RoleViewModels;
using blog.Data;
using blog.ExtendMethods;
using blog.Models;
...
namespace blog.Areas.Identity.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public RoleController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, BlogDbContext context, UserManager<BlogUser> userManager)
        {
            _logger = logger;
