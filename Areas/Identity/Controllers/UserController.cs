...
using blog.Areas.Identity.Models.UserViewModels;
using blog.Data;
...
namespace blog.Areas.Identity.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(ILogger<RoleController> logger, RoleManager<IdentityRole> roleManager, BlogDbContext context, UserManager<BlogUser> userManager)
        {
            _logger = logger;
